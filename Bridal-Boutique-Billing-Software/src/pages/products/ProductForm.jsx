...
export default function ProductForm() {
  ...
  const handleSubmit = async () => {
    ...
    if (!form.unit.trim()) {
      show("warn", "Missing Field", "Unit is required (e.g. kg, litre, piece).");
      return;
    }
    ...
    if (
      gstEnabled &&
      (isNaN(Number(form.gst)) || Number(form.gst) < 0 || Number(form.gst) > 100)
    ) {
      show(
        "warn",
        "Invalid GST",
      ...
      if (galleryFiles.length > 0) {
        try {
          galleryData = await Promise.all(
            galleryFiles.map((file) => readFileAsDataUrl(file))
          );
        } catch (err) {
          console.error(err);
      ...
      <div className="pf-page">
        ...
        <div className="pf-card">
          ...
          <div className="pf-body">
            ...
            <div className="pf-field">
              <label className="pf-label">Product Description</label>
              <textarea
                className="pf-input"
            ...
            <div className="pf-grid-2">
              <div className="pf-field">
                <label className="pf-label">Embroidery / Work</label>
                <div className="pf-input-wrap">
                  <input
                    className="pf-input"
            ...
            <p className="pf-section" style={{ marginTop: "1.25rem" }}>
              Media
            </p>
            ...
            <div className="pf-field">
              <label className="pf-label">Product Video (upload file or remote URL)</label>
              <input
                type="file"
                accept="video/*"
              ...
              {gstLoading ? (
                ...
                <div className="pf-input-wrap pf-gst-field">
                  <span
                    ...
                    style={{ fontWeight: 700, fontSize: 13, color: "#64748b" }}
                  >
                    %
                  </span>
                  <input
